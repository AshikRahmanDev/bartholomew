    ...
    <div data-aos="fade-up">
      <div className="min-h-[200px] bg-madBlack text-white flex justify-between items-center py-5 mt-6">
        <div className="w-[90%] xl:w-[1200px] mx-auto flex flex-col justify-center items-center">
          ...
          <div className="flex">
            <a
              className="w-[45px] h-[45px] bg-white rounded-full flex justify-center items-center mx-3"
              target="_blank"
              rel="noreferrer"
              href="https://www.facebook.com/profile.php?id=100092204199645"
            >
          ...
          <div className="mt-5 flex flex-col items-center pt-3">
            <p className="flex items-center">
              <BsFillTelephoneFill className="mr-2 text-primary" />{" "}
